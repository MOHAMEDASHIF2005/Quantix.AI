    ...
    <div className="min-h-screen relative flex items-center justify-center bg-base-950 overflow-hidden text-ink-100">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="font-display text-2xl font-bold tracking-tight text-ink-100">Welcome Back</h2>
          <p className="text-sm text-ink-500 mt-1">Sign in to manage your inventory forecasts</p>
        </div>
        ...
        <p className="text-center text-xs text-ink-500 mt-6">
          ...
          <Link to="/signup" className="text-signal-indigo hover:underline font-semibold">
            Create an account
          </Link>
        </p>
      </motion.div>
